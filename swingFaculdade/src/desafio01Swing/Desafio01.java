...
public class Desafio01 {
    ...
    private static JFrame montarFrame() {
    ...
    private static void componentesTop(JFrame f) {
    ...
    private static void montarSeparadorTop(JFrame f) {
    ...
    private static void componetesMid(JFrame f) {

        int larguraD = 290; //DEFAULT COMP WIGHT
    ...
    private static void montarSeparadorMid(JFrame f) {
    ...
    private static void btnFinalForm(JFrame f) {
    ...
    private static void configFrame(JFrame f) {
    ...
    private static void startSystem() {
        ...
        menuBar(f);
        componentesTop(f);
        montarSeparadorTop(f);
        componetesMid(f);
        montarSeparadorMid(f);
        btnFinalForm(f);
        configFrame(f);
